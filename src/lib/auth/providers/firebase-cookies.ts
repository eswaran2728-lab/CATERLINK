 ...
 *  just names and durations, safe to import from either side. Same names
 *  as VECTA's — cookies are per-origin anyway, no collision risk between
 *  the two apps' separately deployed domains. */
