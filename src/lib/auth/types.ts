...
/**
 * Placeholder for the normalised app_role/vendor_id claim shape defined
 * in AUTH-CONTRACT.md (Phase 2). Not used yet — role and status
 * resolution still goes through lib/auth.ts's own profile table lookup
